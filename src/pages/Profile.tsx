    ...
    return (
        <Container>
            ...
            <ProfileCard>
                ...
                <StatsSection>
                    <StatBox>
                        <StatValue>{reviewsLoading ? '...' : userReviews.length}</StatValue>
                    ...
                    <StatBox>
                        <StatValue>
                            {reviewsLoading ? '...' : userReviews.reduce((sum, r) => sum + (r.likes?.length || 0), 0)}
                        </StatValue>
                                ...
                                <ReviewList>
                                    {userReviews.slice(0, 5).map((review) => (
                                        <ReviewItem key={review.id}>
                                            <ReviewHeader>
                                                <ReviewTitle>{review.movieTitle || '영화 제목 없음'}</ReviewTitle>
                                                <ReviewRating>⭐ {review.rating}/10</ReviewRating>
                                            </ReviewHeader>
                                            <ReviewContent>{review.content || review.comment}</ReviewContent>
                                            <ReviewMeta>
                                                ❤️ {review.likes?.length || 0} · {formatDate(review.createdAt)}
                                            </ReviewMeta>
                                        </ReviewItem>
                                    ))}
                                </ReviewList>
